            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="rounded-full flex items-center gap-2 h-10 px-4 bg-gradient-primary text-primary-foreground hover:opacity-90 cursor-pointer"
                  >
                    <UserIcon className="h-4 w-4" />
                    <span className="text-xs font-bold hidden lg:inline-block">
                      {user.full_name}
                    </span>
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem
                    ...
                    className="text-red-650 hover:bg-red-50 hover:text-red-700"
                  >
              ...
              <>
                <Button
                  variant="ghost"
                  className="text-primary font-medium hidden sm:inline-flex cursor-pointer"
                  onClick={() => authModal.show("login")}
                >
                  Log in
                </Button>
                <Button
                  className="rounded-full bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow px-5 cursor-pointer"
