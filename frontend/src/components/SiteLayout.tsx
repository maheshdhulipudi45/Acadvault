      ...
      <footer className="bg-[oklch(0.2_0.04_270)] text-white/80 mt-16">
        <div className="mx-auto max-w-[1400px] px-4 lg:px-8 py-12 grid grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-10 md:gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-white/60 max-w-xs">
              One place for all your academic needs.<br />Share knowledge. Empower students.
            </p>
            <div className="flex gap-2 mt-5">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition">
          ...
          <div>
            ...
            <p className="text-sm text-white/60 mb-3">Stay updated with new resources every week.</p>
            <div className="flex flex-col sm:flex-row gap-2.5">
              <Input placeholder="Enter your email" className="bg-white/10 border-white/20 text-white placeholder:text-white/40 rounded-lg w-full" />
              <Button className="rounded-lg bg-gradient-primary text-primary-foreground hover:opacity-90 shrink-0 w-full sm:w-auto cursor-pointer">Subscribe</Button>
            </div>
          </div>
        </div>
        <div className="border-t border-white/10">
          <div className="mx-auto max-w-[1400px] px-4 lg:px-8 py-5 flex items-center justify-between text-xs text-white/50">
            ...
            <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="h-8 w-8 rounded-md bg-white/10 hover:bg-white/20 flex items-center justify-center">
