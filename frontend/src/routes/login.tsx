...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[oklch(0.08_0.02_270)] flex flex-col items-center justify-start sm:justify-center p-4 pt-20 pb-10 sm:py-4 relative overflow-y-auto">
      ...
      <div className="absolute top-[30%] right-[10%] w-[300px] h-[300px] rounded-full bg-indigo-500/10 blur-[90px] animate-float pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-xs text-violet-400/80 font-medium tracking-wider uppercase inline-flex items-center gap-1.5 mt-1 bg-violet-500/10 px-3 py-1 rounded-full border border-violet-500/20">
            <Sparkles className="h-3.5 w-3.5" /> Premium Study Portal
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-zinc-400 text-sm mb-6">Enter your credentials to access the vault.</p>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs text-zinc-400">
              <label className="flex items-center gap-2 cursor-pointer select-none hover:text-zinc-300 transition-colors">
